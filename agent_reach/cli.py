...
def _cmd_check_update():
    ...
    try:
        ...
        resp = requests.get(
            "https://api.github.com/repos/AustinWp/Agent-Reach/releases/latest",
            timeout=10,
        )
        if resp.status_code == 200:
            data = resp.json()
            ...
            if latest and latest != __version__:
                ...
                print()
                print("更新命令:")
                print("  pip install --upgrade https://github.com/AustinWp/Agent-Reach/archive/main.zip")
            ...
            resp2 = requests.get(
                "https://api.github.com/repos/AustinWp/Agent-Reach/commits/main",
                timeout=10,
            )
    ...
    if update_available:
        ...
        if release_body:
            for line in release_body.strip().split("\n")[:10]:
                print(f"    {line}")
        print(f"  更新: pip install --upgrade https://github.com/AustinWp/Agent-Reach/archive/main.zip")
